    ...
    async function handleResend() {
        ...
        try {
            ...
            notification.success({
                text: "OTP is generated. Check your inbox",
            });
        } catch (error: any) {
            if (error.response) {
...
<section class="space-y-8 h-full bg-secondary">
    ...
    <div
        class="px-6 py-5 mx-4 flex flex-col gap-4 bg-orange-50 rounded-[1.6rem] lg:w-[30vw] lg:mx-auto"
    >
        ...
        <button
            on:click={verify_status === "not_verified"
                ? handleVerify
                : () => {}}
