...
<figure class="">
    ...
    <section
        class="lg:w-[70vw] lg:shadow-lg px-4 lg:grid lg:grid-cols-6 lg:p-10 text-secondary lg:min-h-[50vh] lg:rounded-xl lg:bg-light lg:absolute lg:top-[50%] lg:left-[50%] lg:-translate-x-[50%] lg:-translate-y-[50%]"
    >
        <div
        ...
        >
            ...
            >
                <span class="text-3xl lg:text-2xl font-medium text-[#FF4500]"
                    >Important!</span
                >
                <span
                    class="text-[#FF4500] leading-relaxed lg:text-sm lg:leading-loose"
            ...
            <div>
                <button
                    class="lg:p-2 p-3 px-10 lg:px-4 hover:rounded-none transition-all rounded-md bg-cto text-light font-medium text-xl lg:text-lg"
