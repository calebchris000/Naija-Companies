...
<section
    class="lg:max-h-[280vh] lg:w-full h-fit bg-primary space-y-10 shapedividers_com-3867 p-4 py-40"
>
    <span
    ...
    >
    <section
        class="grid max-h-[1000px] grid-cols-1 lg:grid-cols-6 lg:grid-rows-3 gap-4 lg:h-[140vh] lg:px-10"
    >
        <div
        ...
        <div class="lg:col-span-3 mt-16 text-secondary flex flex-col gap-4">
            ...
            <button
                ...
                class="self-start mt-5 1-full flex items-center bg-accent text-primary p-4 gap-4 rounded-lg"
                type="button"
            >
