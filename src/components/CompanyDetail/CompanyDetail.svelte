...
<section
    class="h-[16rem] bg-gray-800 text-white shadow-sm space-y-6 p-4 lg:w-full lg:p-6 lg:h-[80vh]"
>
    <div class="flex items-center gap-20">
        ...
        <div class="flex flex-col">
            <span class="font-medium text-lg lg:text-4xl lg:font-semibold"
                >{organization_name}</span
            >
            <span style="color: {star_color}" class="text-xl lg:text-4xl"
                >{stars}</span
            >
